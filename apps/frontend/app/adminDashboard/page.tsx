    ...
    <div className="min-h-screen bg-[#fcf9f8] text-[#1c1b1b] font-sans selection:bg-[#f5c800]">
      ...
      <main className="p-8 lg:p-12 max-w-7xl mx-auto space-y-12">
        ...
        <div className="flex justify-between items-end">
           <div>
              <h1 className="text-4xl font-black text-[#1c1b1b] tracking-tight">Vue Globale Systeme</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
           ...
           <div className="bg-white p-6 justify-between rounded-2xl border border-black/5 shadow-xl shadow-black/[0.02]">
              ...
              <h3 className="text-[#a1a1aa] font-bold text-xs uppercase tracking-wider">Etat Serveurs (NestJS)</h3>
           ...
           <div className="bg-[#1c1b1b] p-6 justify-between rounded-2xl border border-black/5 shadow-xl shadow-black/[0.02] relative overflow-hidden">
              ...
              <h3 className="text-white/60 font-bold text-xs uppercase tracking-wider">Requetes DB / s</h3>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group bg-white rounded-2xl border border-black/5 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer">
               ...
               <p className="text-sm text-[#a1a1aa] mt-2 font-medium">Gerer les roles, les politiques de mot de passe et l'authentification SSO.</p>
            </div>
            <div className="group bg-white rounded-2xl border border-black/5 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer">
               ...
               <p className="text-sm text-[#a1a1aa] mt-2 font-medium">Visionner les tables Tickets, Users, Payments et editer les logs en direct.</p>
            </div>
            <div className="group bg-white rounded-2xl border border-black/5 p-6 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer">
               <Mail className="w-6 h-6 text-[#1c1b1b] mb-4 group-hover:scale-110 transition-transform" />
               <h4 className="font-bold text-lg text-[#1c1b1b]">SMTP (Verification OTP)</h4>
               <p className="text-sm text-[#a1a1aa] mt-2 font-medium">Logs d'envoi des codes de verification par email ou SMS.</p>
            </div>
          </div>
        </div>
