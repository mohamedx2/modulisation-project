...
try { fs.writeFileSync("app/dashboard/layout.tsx", layoutSrc, { encoding: "utf8" }); } catch(e) {}

let step2 = fs.readFileSync("app/dashboard/step2/page.tsx", "utf8");
step2 = step2.replace("Tool", "Wrench").replace("Tool,", "Wrench,");
try { fs.writeFileSync("app/dashboard/step2/page.tsx", step2, "utf8"); } catch(e) {}
