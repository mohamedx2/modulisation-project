    ...
    <div className="bg-[#1c1b1b] min-h-screen w-full relative flex flex-col items-center overflow-hidden font-sans selection:bg-[#f5c800] selection:text-[#1c1b1b]">
      ...
      <main className="relative z-30 flex-1 flex flex-col items-center justify-center w-full max-w-7xl px-4 sm:px-8 mt-12 pb-24">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
            ...
            <span className="text-xs font-bold text-[#a1a1aa] uppercase tracking-[2px]">Syst�me central d&apos;ing�nierie</span>
          </div>
          ...
          <h1 className="font-black text-5xl sm:text-6xl md:text-7xl lg:text-[80px] leading-[1.05] tracking-tight text-white drop-shadow-2xl mb-10">
            ...
            Contr�le <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-white">Total.</span>
          </h1>

          <p className="font-medium text-[#a1a1aa] text-lg sm:text-xl md:text-2xl leading-relaxed max-w-3xl mb-16">
            Plateforme unifi�e pour la gestion d&apos;interventions, la facturation automatis�e et la reconnaissance OCR des v�hicules Renault.
          </p>
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/10">
          {[
            { tag: "01", icon: Activity, title: "Suivi Temps R�el", desc: "Monitorez l&apos;�tat des interventions au fil de l&apos;eau." },
            { tag: "02", icon: ShieldCheck, title: "S�curit� Keycloak", desc: "Authentification SSO robuste pour les collaborateurs." },
            { tag: "03", icon: BarChart4, title: "Analytique Int�gr�e", desc: "Rapports de rentabilit� et volumes de facturation." }
          ].map((feat) => (
